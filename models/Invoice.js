...
const invoiceItemSchema = new mongoose.Schema({
  ...
  taxLines:     [{ taxCode: String, taxName: String, rate: Number, amount: Number, businessTax: Boolean, reducedBy: [String] }],
  taxAmount:       { type: Number, default: 0 },
  customerTaxAmount:{ type: Number, default: 0 },
  businessTaxAmount:{ type: Number, default: 0 },
  lineSubtotal: { type: Number, default: 0 },
  lineTotal:    { type: Number, default: 0 },
  location:     { type: mongoose.Schema.Types.ObjectId, ref: 'StoreLocation' },
  locationName: { type: String, default: '' },
  // ── Partial delivery tracking (Proforma/Invoice flow) ──
...
const invoiceSchema = new mongoose.Schema({
  ...
  taxInvoice:      { type: Boolean, default: false },
